          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$product->id}}</td>
                  <td><img class="image-fluid" src="{{URL::to('/public/images/'.$product->image)}}" style="width:50px; height:50px;" alt=""></td>
                  <td>{{$product->title}}</td>
                  <td>{{$product->description}}</td>
                  <td>{{$product->price}}</td>
                  <td>
                      <a href="{{URL::to('')}}/user/edit/{{ $product->id }}" type="button" class="btn btn-block btn-info">
                        Edit
                      </a>
                      <a href="{{URL::to('')}}/user/block/{{ $product->id }}" type="button" class="btn btn-block btn-warning">
                        Block
                      </a>
                  </td>
                </tr> 
